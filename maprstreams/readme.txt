...
Ex/-java -cp `mapr classpath`:./maprstreams-0.0.1-SNAPSHOT-jar-with-dependencies.jarcom.masteklabs.streams.SimpleConsumer test latest
...
Ex/-java -cp `mapr classpath`:./maprstreams-0.0.1-SNAPSHOT-jar-with-dependencies.jar com.masteklabs.streams.SimpleProducer 20 223232 300
